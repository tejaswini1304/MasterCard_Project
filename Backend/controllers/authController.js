...
exports.signup = catchAsync(async (req, res, next) => {
    const { name, email, password, passwordConfirm, address, role } = req.body;
    ...
    createSendToken(tempUser, 200, req, res);
});
...
exports.verifyOtp = catchAsync(async (req, res, next) => {
    ...
    const { name, email, password, address, role } = tempUser;
